...
//   } else{
 ...
 {
   $ret=mysqli_query($con,"select Heslo from uzivatele where Email='".$_POST['email']."'");
...
$query=mysqli_query($con,"INSERT INTO uzivatele VALUES ('".$email."','".$jmeno."','".$prijmeni."','".$hash."','".$cislo."')");
 $_SESSION['msg']="Uživatel úspěšně přidán";
 }
?>
  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Nový uživatel</h3>
				...
				<div class="row">
                  ...
                  <div class="col-md-12">
                      ...
                      <p align="center" style="color:#55f759;"><?php echo $_SESSION['msg'];?><?php echo $_SESSION['msg']=""; ?></p>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="prijmeni" value="" >
                              </div>
                          </div>
                              ...
                              <div class="col-sm-10">
                                  <input type="password" class="form-control" name="heslo" value="" >
                              </div>
                          </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Tel. číslo </label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="cislo" value="">
                              </div>
                          </div>
                          <div style="margin-left:100px;">
                          <input type="submit" name="Submit" value="Přidat" class="btn logout"></div>
                          </form>
                      </div>
                  </div>
              </div>
